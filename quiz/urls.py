...
urlpatterns = [
   ...
   path('addquestiontype/',quiz_views.question_type,name='addquestiontype'),
   ...
   path('edit/<str:quiz_name1>/<str:question_type>/<str:id>/',quiz_views.editquestion,name='editquestion'),
   ...
   path('privatequiz/<str:quiz_name1>/',quiz_views.private_quiz,name='privatequiz'),
   path('export/',quiz_views.export_index,name='exportindex'),
   path('export/<str:quiz_name1>/',quiz_views.export_result,name='export')
]
